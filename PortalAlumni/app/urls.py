...
urlpatterns=[
    ...
    url(r'^(?P<pk>\d+)/event/comment/$',views.eventcommentform,name='eventcommentform'),
    url(r'^(?P<pk>\d+)/event_detail/$',views.eventDetailwithcomment,name='eventDetailwithcomment'),
]
